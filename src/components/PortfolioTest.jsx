...
const ProjectCard = ({
  ...
  >
    <div className="flex flex-col items-start gap-4 sm:flex-row">
      <div className="flex items-center justify-center flex-shrink-0 w-full h-auto overflow-hidden rounded-lg sm:w-16 sm:h-12 bg-slate-100 dark:bg-slate-700 aspect-video sm:aspect-auto">
        {img ? (
          <img src={img} alt={title} className="object-cover w-full h-full" />
        ) : (
          <div className="p-4 text-sm text-slate-500">No image</div>
        )}
      </div>
            ...
            <section className="grid items-center gap-8 mt-8 md:grid-cols-2">
              ...
              >
                ...
                <div className="w-full max-w-sm overflow-hidden border shadow-lg rounded-2xl dark:border-slate-700">
                  <img
                    src="https://placehold.co/1200x800/f97316/ffffff?text=Portfolio+Image"
                    alt="work preview"
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300">
                        ...
                        to help product recommendations and business reporting.
                      </p>
                    ...
                    <div>
                      <div className="w-full h-48 mb-3 overflow-hidden rounded-lg bg-slate-100 dark:bg-slate-700">
                        <img
                          src="https://placehold.co/1200x800/ef4444/ffffff?text=Case+Study+Dashboard"
                          alt="somi"
            ...
            <section className="grid gap-6 mt-8 md:grid-cols-3">
              <div className="p-6 bg-white border md:col-span-2 dark:bg-slate-800 rounded-2xl">
                ...
                <ul className="mt-2 ml-5 space-y-1 text-base list-disc text-slate-600 dark:text-slate-300">
                  ...
                  <li>
                    Developed SamsanHub — AI insight platform with API
                    integrations.
                  </li>
                  <li>
              ...
              <aside className="p-6 bg-white border dark:bg-slate-800 rounded-2xl">
                ...
                <div className="flex flex-col gap-2 mt-4">
                  <a
                    href="mailto:kelvinwilliams@example.com"
